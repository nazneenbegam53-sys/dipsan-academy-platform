        ...
        <div className="mt-10 space-y-8">
          <section className="rounded-2xl border border-white/10 bg-charcoal/50 p-5">
            ...
            <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-bronze">
              ...
              <li>Tap <span className="text-mist">Install free app</span> above, or the browser menu → Install app.</li>
          ...
          <section className="rounded-2xl border border-white/10 bg-charcoal/50 p-5">
            ...
            <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-bronze">
              ...
              <li>Tap Share → <span className="text-mist">Add to Home Screen</span>.</li>
          ...
          <section className="rounded-2xl border border-gold/20 bg-gold/5 p-5">
            ...
            <p className="mt-3 text-sm text-bronze">
              ...
              works today. When you are ready for stores, the Capacitor projects in this repo are
              already prepared — see <code className="text-mist">client/MOBILE_APP.md</code>.
            </p>
          </section>
        </div>

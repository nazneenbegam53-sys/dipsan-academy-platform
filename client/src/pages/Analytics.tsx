      ...
      {data.submissionCount === 0 ? (
        ...
        <>
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-8">
            <Card className="p-4"><div className="text-xs text-bronze">SUBMISSIONS</div><div className="text-lg font-bold text-ink">{data.submissionCount}</div></Card>
            <Card className="p-4"><div className="text-xs text-bronze">AVERAGE</div><div className="text-lg font-bold text-ink">{data.averageScore}</div></Card>
            <Card className="p-4"><div className="text-xs text-bronze">HIGHEST</div><div className="text-lg font-bold text-ink">{data.highestScore}</div></Card>
            <Card className="p-4"><div className="text-xs text-bronze">LOWEST</div><div className="text-lg font-bold text-ink">{data.lowestScore}</div></Card>
            <Card className="p-4"><div className="text-xs text-bronze">PASS %</div><div className="text-lg font-bold text-ink">{data.passPercentage}%</div></Card>
          </div>

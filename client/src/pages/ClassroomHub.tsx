...
import { Board, Classroom } from "../types";
...
export default function ClassroomHub() {
  ...
  const boardBase = `${home}/classroom/board`;
  ...
  function loadClassrooms(preferId?: string) {
    ...
    classroomApi
      ...
      .catch((err) => setError(err.message || "Could not load classrooms."))
  ...
  useEffect(() => {
    ...
    boardApi
      ...
      .catch((err) => setError(err.message || "Could not load boards."))
                      ...
                      {boards.map((b) => (
                        ...
                        >
                          ...
                          <div className="flex flex-wrap gap-2">
                            <Button
                              variant={b.liveEnded ? "ghost" : "primary"}
                              onClick={() => navigate(`${boardBase}/${b._id}`)}
                            >

...
router.post("/:examId/start", protect, requireRole("student"), requireSubscription, startAttempt);
...
router.get("/:attemptId/result", protect, requireRole("student"), requireSubscription, getMyAttemptResult);
